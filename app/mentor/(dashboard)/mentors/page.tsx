...
function mapAcceptedMenteeToMentee(mentee: AcceptedMentee): Mentee {
  return {
    ...
    email: mentee.email,
    age: mentee.menteeAge ?? 0,
    location: mentee.menteeLocation ?? "",
...
export default function MentorPage() {
  ...
  return (
    <div className="container mx-auto py-2 h-full">
      <h1 className="text-4xl font-medium mb-4 border-b border-grey-300 pb-6 pt-4">
        Mentor
      </h1>
      ...
      {selectedMentee && (
        <>
          <MenteeProfileDialog
            mentee={{
              ...
              firstName:
                ...
                selectedMentee.name?.split(" ")[0] ||
                "",
              lastName:
                selectedMentee.lastName ||
                selectedMentee.name?.split(" ")[1] ||
                "",
              interests: Array.isArray(selectedMentee.interests)
                ? selectedMentee.interests.map((interest: any) =>
          ...
          <MenteeChatDialog
            ...
            open={showMenteeChat}
            onOpenChange={setShowMenteeChat}
          />
        </>
      )}
